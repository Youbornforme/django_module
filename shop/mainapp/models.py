...
def get_product_url(obj, viewname):
    ...
    return  reverse(viewname, kwargs={'ct_models': ct_model, 'slug': obj.slug})


class MyUser(AbstractSet):
...
class LatestProductsManager:
    ...
    def get_products_for_main_page(*args, **kwargs):
        ...
        products = []
        ct_model = ContentType.objects.filter(model__in=args)
        for ct_model in ct_model:
...
class CategoryManager(models.Manager):
    ...
    CATEGORY_NAME_COUNT_NAME = {
        'Macbook': 'macbook__count',
        'Iphone': 'iphone__count'
    }
    ...
    def get_categories_for_left_sidebar(self):
        models = get_models_for_count('macbook', 'iphone')
...
class CartProduct(models.Model):
    ...
    cart = models.ForeignKey('Cart', verbose_name='Корзина', on_delete=CASCADE, related_name='related_products')
...
class Customer(models.Model):
    ...
    user = models.ForeignKey(User, verbose_name='Польователь', on_delete=models.CASCADE)
